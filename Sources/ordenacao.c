...
void Ordenacao_Iterativo(Dados *dados, int Esq, int Dir){
    ...
    do{
        ...
        // Na possição pilha_i[t][0] guarda os valores i para cada vez que o while roda
        // é em pilha_i[t][1] gurda um marcador para saber se aquele indice já foi usado como
        // Esq, 1 quando já foi usado é zero quando ainda não foi
